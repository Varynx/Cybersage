...
final List<Map<String, dynamic>> quizQuestions = [
  {
    'question':
        'A pop-up window appears on your device while browsing the internet, claiming that your device is infected with a virus,'
  ...
  {
    'question':
        'You notice a suspicious charge on your credit card statement from an unknown online store. How should you respond?',
    'options': [
  ...
  {
    'question':
        'The following email has been sent to your inbox claiming that an invoice of'
  ...
  {
    'question':
        'Look at the following email. What are some signs that this is a phishing attempt?',
    'options': [
...
class QuizPageState extends State<QuizPage> {
  ...
  void nextQuestion() {
    if (currentQuestionIndex < quizQuestions.length - 1) {
      ...
      // Store score and show quiz completion dialog
