...
final List<Map<String, String>> cybersecurityLessons = [
  {
    ...
    'top_image': 'assets/Phishing_Fischer.png',
  },
  {
    ...
    'bot1_image': 'assets/Phishing_Example1.png',
    'bot2_image': 'assets/Phishing_Example2.png',
  },
  {
  ...
  },
  {
    ...
    'bot1_image': 'assets/Identity_Theft_Examples.png',
  },
  {
  ...
  },
  {
    ...
    'audio_mobile': 'scam_audio2.mp3', // 🎧 Audio file for Mobile
    'audio_windows': 'scam_audio2.mp3',
  },
];
...
class _LessonPageState extends State<LessonPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final hasAudio =
        currentLesson['audio_web'] != null ||
        currentLesson['audio_mobile'] != null;
                      ...
                      if (hasAudio)
                        Center(
                          child: ElevatedButton.icon(
                            onPressed:
                                () => toggleAudio(
                                  currentLesson['audio_web'] ??
                                      '', // Web Audio Path
                                  currentLesson['audio_mobile'] ??
                                      '', // Mobile Audio Path
                                ),
                            icon: Icon(
